...
class NestedSampler(object):
    ...
    def __init__(self,
        ...
        self.nthreads       = manager.nthreads
        ...
        if trainer:
            ...
            self.logger.warning('Periodic checkpoint is not yet implemented with flows')
    ...
    def initialise_trainers(self):
        """
        Initialise the models in the training thread and sampling threads
        """
        if self.trainer:
            ...
            # setup variables
            self.training_data = list()  # Data that has yet to be trained on
            self.retrain = False
